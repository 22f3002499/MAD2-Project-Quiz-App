...
const routes = [
  {path : "/login" , component : () => import('@/views/user/LoginView.vue') , meta : {guest : true}},
  ...
  {path : "/begin-quiz/:quizId/" , component : () => import('@/views/user/BeginQuizView.vue') , meta : {authRequired: true}},
